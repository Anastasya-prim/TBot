...
/**
 * Инициализация SQLite (основное хранилище вместо Google Sheets).
 * Совместимое имя с прежним initSheetsClient для минимальных правок в index.
 */
...
/** Имена таблиц для экспорта CSV (менеджеры). */
